...
public class UsersRepositoryImpl implements UsersRepository {
    ...
    //language=SQL
    private final static String SQL_INSERT = "insert into semester_user(first_name, last_name, email, hash_password) " +
            "values (?, ?, ?, ?)";
    private final static String SQL_FIND_BY_EMAIL = "select *from semester_user where email = ";
